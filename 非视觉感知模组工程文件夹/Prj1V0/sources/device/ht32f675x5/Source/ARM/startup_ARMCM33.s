...
; User setup Stack & Heap
                ...
                EXPORT   __initial_sp
                ; __heap_base / __heap_limit are generated by the linker from the scatter file RAM_MP_HEAP region

;====================================================================
; Weak symbol for __alloca_initialize (called by C library init)
;====================================================================
                IF       :LNOT::DEF:__MICROLIB
                EXPORT   __alloca_initialize
__alloca_initialize
                BX       LR
                ENDIF

;====================================================================
; __user_heap_extent - defined as weak symbol pointing to __heap_limit
;====================================================================
                IF       :LNOT::DEF:__MICROLIB
                EXPORT   __user_heap_extent [DATA]
__user_heap_extent
                DCD      __heap_limit
                ENDIF
