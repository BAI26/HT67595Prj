...
#define RAM_MP_DATA_SIZE_MAX               (84 * KBYTE)

// MP STACK and HEAP in SDK
#define RAM_MP_STACK_SIZE_MAX              (4 * KBYTE) // @ref startup_ARMCM33.s
#define RAM_MP_HEAP_SIZE_MAX               (4 * KBYTE) // @ref startup_ARMCM33.s
#define RAM_MP_STACK_HEAP_SIZE_MAX         (RAM_MP_STACK_SIZE_MAX + RAM_MP_HEAP_SIZE_MAX)
#define RAM_MP_HEAP_ADDR                   (RAM_MP_DATA_ADDR + RAM_MP_DATA_SIZE_MAX - RAM_MP_STACK_HEAP_SIZE_MAX)
#define RAM_MP_STACK_ADDR                  (RAM_MP_HEAP_ADDR + RAM_MP_HEAP_SIZE_MAX)
...
#define FLASH_MP_APP_CODE_SIZE_MAX         (162 * KBYTE)
...
#define UART_BPS_MP_APP_DEBUG              (115200)
...
#define SYSTEM_CLOCK_PLL64M_ENABLED        (1)  // 0=DCXO16M(16MHz), 1=PLL64M(64MHz)
...
/* TFLM Hello World (sine) self-test on MP UART */
#ifndef TFLM_HELLO_TEST_ENABLED
...
#define FALL_DETECT_ENABLED              (1)   // 0=Disable, 1=Enable inference
#endif
