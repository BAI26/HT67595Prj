...
static void system_clock_init(EN_SYS_CLK_SRC_SEL_T enSysClkSrc)
{
   ...
   rom_hal_pmu_cfg_dcxo_hclk_param(DCXO_HCLK_IB_5, DCXO_HCLK_NGM_3, DCXO_HCLK_CAP_10PF);
   ...
   rom_hal_pmu_set_lpwr_clk_src(LPWR_CLK_DCXO_LCLK,DCXO_LCLK_STABLE_TIME_500MS);
}
