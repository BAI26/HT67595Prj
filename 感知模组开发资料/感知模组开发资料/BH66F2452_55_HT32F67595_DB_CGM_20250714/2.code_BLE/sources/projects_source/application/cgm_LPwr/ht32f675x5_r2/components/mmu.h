...
typedef enum {
    ...
    EN_MMU_BLE_POWER_ON_COUNT    = 0x07,    // Corrected the label for power-on count
    EN_MMU_BLE_SAMPLING_INTERVAL = 0x08,    // Give a new value for BLE Sampling Interval
    EN_MMU_BLE_SENDING_INTERVAL  = 0x09,    // Give a new value for BLE Sending Interval
