...
static void peripheral_init(void)
{
    ...
    // App timer init
    app_timer_init();
    rom_hw_pmu_set_wakeup_source(LUT_INDEX_STIM_WAKEUP, LUT_TRIG_ID_OTHER, LUT_TRIG_ID_STIM1_CH3, LUT_ACT_PD_SYS_ON | LUT_ACT_DCXO_HCLK_ON | LUT_ACT_CP_IRQ_EN);
...
void app_main(void *argument)
{
    ...
    PRINTF("------------BestHealth CGM Demo Code HT32F67595 + BH66F24xx ------------\n");
